...
sh_ver="1.3.1"
github="raw.githubusercontent.com/ss-daily-backup-002/Linux-NetSpeed-cx9208/master"
...
startlotserver(){
	...
	bash <(wget -qO- https://github.com/MoeClub/lotServer/raw/master/Install.sh) install
	start_menu
}
